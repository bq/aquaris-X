 ...
 *  This file was generated automatically on 05/27/16 at 11:58:23. 
 *  Source file: TFA9872N1A_DefaultI2CSettings - 25.xlsx
 */
...
typedef enum nxpTfa9872BfEnumList {
    ...
    TFA9872_BF_TDMSPKS= 0x2603,    /*!< tdm slot for  channel in 0 (speaker + dcdc)        */
    TFA9872_BF_TDMDCS= 0x2643,    /*!< tdm slot for  channel in 1  (dcdc)                 */
    ...
    TFA9872_BF_ISTLA = 0x4260,    /*!< Status low amplidetude detection                   */
    ...
    TFA9872_BF_ICLLA = 0x4660,    /*!< Clear low amplidetude detection                    */
    ...
    TFA9872_BF_IELA  = 0x4a60,    /*!< Enable low amplidetude detection                   */
    ...
    TFA9872_BF_BSSBY = 0x50f0,    /*!< Bypass HW clipper                                  */
    ...
    TFA9872_BF_TDMSPKG= 0x6123,    /*!< Total Gain attenuation  setting for amplifier gain (tdm channel 1) input_level(INPLEV)=0[dB] */
    TFA9872_BF_TDMDCG= 0x6163,    /*!< Gain attenuation setting for tdm channel 0         */
    TFA9872_BF_VDDPSEL= 0x6631,    /*!< external boost                                     */
    TFA9872_BF_TDMSRCMAP= 0x6801,    /*!< tdm source mapping                                 */
    TFA9872_BF_TDMSRCAS= 0x6821,    /*!< frame a selection                                  */
    TFA9872_BF_TDMSRCBS= 0x6841,    /*!< frame b selection                                  */
    ...
    TFA9872_BF_DCMCC = 0x7033,    /*!< Max coil current (to be update)                    */
    ...
    TFA9872_BF_DCVOF = 0x7402,    /*!< First boost voltage level                          */
    TFA9872_BF_DCTRACK= 0x7430,    /*!< Boost algorithm selection, effective only when boost_intelligent is set to 1 */
    TFA9872_BF_DCTRIP= 0x7444,    /*!< Adaptive boost trip levels, effective only when boost_intelligent is set to 1 */
...
#define TFA9872_NAMETABLE static tfaBfName_t Tfa9872DatasheetNames[]= {\
   ...
   { 0x2603, "TDMSPKS"},    /* tdm slot for  channel in 0 (speaker + dcdc)       , */\
   { 0x2643, "TDMDCS"},    /* tdm slot for  channel in 1  (dcdc)                , */\
   ...
   { 0x6123, "TDMSPKG"},    /* Total Gain attenuation  setting for amplifier gain (tdm channel 1) input_level(INPLEV)=0[dB], */\
   { 0x6163, "TDMDCG"},    /* Gain attenuation setting for tdm channel 0        , */\
   { 0x6631, "VDDPSEL"},    /* external boost                                    , */\
   ...
   { 0x7402, "DCVOF"},    /* First boost voltage level                         , */\
   { 0x7430, "DCTRACK"},    /* Boost algorithm selection, effective only when boost_intelligent is set to 1, */\
   { 0x7444, "DCTRIP"},    /* Adaptive boost trip levels, effective only when boost_intelligent is set to 1, */\
...
#define TFA9872_BITNAMETABLE static tfaBfName_t Tfa9872BitNames[]= {\
   ...
   { 0x2603, "tdm_sink0_slot"},    /* tdm slot for  channel in 0 (speaker + dcdc)       , */\
   ...
   { 0x6123, "ctrl_attl"},    /* Total Gain attenuation  setting for amplifier gain (tdm channel 1) input_level(INPLEV)=0[dB], */\
   { 0x6163, "ctrl_attr"},    /* Gain attenuation setting for tdm channel 0        , */\
   ...
   { 0x6631, "icomp_ctrl_se"},    /* external boost                                    , */\
   ...
   { 0x7402, "frst_boost_voltage"},    /* First boost voltage level                         , */\
   { 0x7430, "boost_track"},    /* Boost algorithm selection, effective only when boost_intelligent is set to 1, */\
   { 0x7444, "boost_trip_lvl"},    /* Adaptive boost trip levels, effective only when boost_intelligent is set to 1, */\
   ...
   { 0xc707, "digimuxa_sel"},    /* DigimuxA input selection control routed to DATA0 (see Digimux list for details), */\
   ...
   { 0xd283, "tsig_gain"},    /* inject_tsig tsig_gain inplementation              , */\
   ...
   { 0xd852, "test_spare_out"},    /* test spare out                                    , */\
   ...
   { 0xf987, "spare_mtp9_15_8"},    /* MTP-control FW - See Firmware I2C API document for details, */\
