...
#define TFA98XX_API_REV_MINOR			(1)	/* minor */
#define TFA98XX_API_REV_REVISION		(4)
#define TFA98XX_API_REV_STR			 "3.1.4"
...
#define TFA72_ALGOPARAMETER_LENGTH		(3*168)
...
#if !(defined(TFA9887) || defined(TFA9890) || defined(TFA9887B) || defined(TFA9897)||defined(TFA9896))
#ifndef TFA98XX_FULL
#define TFA98XX_FULL
#endif
#endif

#if (defined(TFA9887) || defined(TFA9890) || defined(TFA9897) || defined(TFA9896))
...
/* Adapt the boost trip level
 *   called when there is a switch between music or a sine wave
 *   @return error code
 */
...
enum Tfa98xx_Error mmap_read_register16(Tfa98xx_handle_t handle,
				       unsigned char subaddress,
				       unsigned short *pValue);

enum Tfa98xx_Error mmap_write_register16(Tfa98xx_handle_t handle,
					unsigned char subaddress,
...
enum Tfa98xx_Error mmap_dsp_write_mem_word(Tfa98xx_handle_t handle,
				    unsigned short address,  int value, int memtype);
