...
typedef enum Tfa98xx_Error (*mem_read_t)(Tfa98xx_handle_t handle, unsigned int start_offset, int num_words, int *pValues);
...
struct tfa_device_ops {
	...
	enum Tfa98xx_Error (*tfa_adapt_boost_trigger_level)(Tfa98xx_handle_t handle, int set_value);
	dsp_msg_t   	dsp_msg;
