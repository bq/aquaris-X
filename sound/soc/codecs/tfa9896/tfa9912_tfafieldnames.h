 ...
 *  This file was generated automatically on 06/20/16 at 09:43:15. 
 *  Source file: TFA9912_N1A_I2C_regmap_V1.22.xlsx
 */
...
#define TFA9912_I2CVERSION    1.22
...
typedef enum nxpTfa9912BfEnumList {
    ...
    TFA9912_BF_AMPE  = 0x0030,    /*!< Activate Amplifier                                 */
    ...
    TFA9912_BF_FSSSEL= 0x0091,    /*!< Audio sample reference                             */
    ...
    TFA9912_BF_MANWDE= 0x01f0,    /*!< Watchdog manager reaction                          */
    ...
    TFA9912_BF_ENBLADC10= 0x02e0,    /*!< ADC10 Enable                                       */
    ...
    TFA9912_BF_AUXSPKSEL= 0x0600,    /*!< Main/Auxiliary input selectyed for TAP/SAM         */
    ...
    TFA9912_BF_SPKS  = 0x1080,    /*!< Speaker error                                      */
    ...
    TFA9912_BF_OCPOAPR= 0x1300,    /*!< OCPOK pmos A                                       */
    TFA9912_BF_OCPOANR= 0x1310,    /*!< OCPOK nmos A                                       */
    TFA9912_BF_OCPOBPR= 0x1320,    /*!< OCPOK pmos B                                       */
    TFA9912_BF_OCPOBNR= 0x1330,    /*!< OCPOK nmos B                                       */
    TFA9912_BF_CLIPAHR= 0x1340,    /*!< Clipping A to Vddp                                 */
    TFA9912_BF_CLIPALR= 0x1350,    /*!< Clipping A to gnd                                  */
    TFA9912_BF_CLIPBHR= 0x1360,    /*!< Clipping B to Vddp                                 */
    TFA9912_BF_CLIPBLR= 0x1370,    /*!< Clipping B to gnd                                  */
    TFA9912_BF_OCDSR = 0x1380,    /*!< OCP  amplifier                                     */
    TFA9912_BF_CLIPSR= 0x1390,    /*!< Amplifier  clipping                                */
    TFA9912_BF_OCPOKMC= 0x13a0,    /*!< OCPOK MICVDD                                       */
    TFA9912_BF_MANALARM= 0x13b0,    /*!< Alarm state                                        */
    ...
    TFA9912_BF_SPKSR = 0x1410,    /*!< Speaker status                                     */
    ...
    TFA9912_BF_VDDP  = 0x1709,    /*!< IC VDDP voltage ( 1023*VDDP/9.5 V)                 */
    TFA9912_BF_DCILCF= 0x17a0,    /*!< DCDC current limiting                              */
    TFA9912_BF_TDMUC = 0x2000,    /*!< Usecase setting                                    */
    TFA9912_BF_DIO4SEL= 0x2011,    /*!< DIO4 Input selection                               */
    TFA9912_BF_TDME  = 0x2040,    /*!< Enable interface                                   */
    ...
    TFA9912_BF_TDMTXDFO= 0x2271,    /*!< Format unused bits                                 */
    ...
    TFA9912_BF_TDMGOE= 0x2330,    /*!< Gain out control                                   */
    TFA9912_BF_TDMVSE= 0x2340,    /*!< Voltage sense                                      */
    TFA9912_BF_TDMCSE= 0x2350,    /*!< Current sense                                      */
    TFA9912_BF_TDMCFE= 0x2360,    /*!< DSP                                                */
    TFA9912_BF_TDMCF2E= 0x2370,    /*!< DSP 2                                              */
    TFA9912_BF_TDMCF3E= 0x2380,    /*!< DSP 3                                              */
    TFA9912_BF_TDMES6= 0x2390,    /*!< Cenable Data Strean for Source 6                   */
    TFA9912_BF_TDMES7= 0x23a0,    /*!< Cenable Data Strean for Source 7                   */
    ...
    TFA9912_BF_TDMCSIO= 0x24a1,    /*!< IO current sense                                   */
    TFA9912_BF_TDMCFIO= 0x24c1,    /*!< IO DSP                                             */
    TFA9912_BF_TDMCFIO2= 0x24e1,    /*!< IO DSP 2                                           */
    TFA9912_BF_TDMLS = 0x2643,    /*!< tdm slot for  channel in 1  (dcdc)                 */
    TFA9912_BF_TDMRS = 0x2683,    /*!< Position audio right                               */
    TFA9912_BF_TDMGOS= 0x26c3,    /*!< Slot Position of Gain Out                          */
    TFA9912_BF_TDMVSS= 0x2703,    /*!< Slot Position of Voltage sense                     */
    TFA9912_BF_TDMCSS= 0x2743,    /*!< Position current sense                             */
    TFA9912_BF_TDMCFS= 0x2783,    /*!< Position DSP                                       */
    TFA9912_BF_TDMCF2S= 0x27c3,    /*!< Position DSP 2                                     */
    TFA9912_BF_TDMCF3S= 0x2803,    /*!< Slot Position of DSP 3                             */
    TFA9912_BF_TDMEDAT6S= 0x2843,    /*!< Slot Position of Extra Data                        */
    TFA9912_BF_TDMEDAT7S= 0x2883,    /*!< Slot Position of Extra Data                        */
    TFA9912_BF_TDMTXUS3= 0x2901,    /*!< Format unused slots D3                             */
    TFA9912_BF_PDMSM = 0x3100,    /*!< PDM control                                        */
    TFA9912_BF_PDMSTSEL= 0x3111,    /*!< Side tone input                                    */
    ...
    TFA9912_BF_ISTLA = 0x4260,    /*!< Status low amplidetude detection                   */
    ...
    TFA9912_BF_ISTTAPTRG= 0x42c0,    /*!< Status Tap comparator tiggered                     */
    ...
    TFA9912_BF_HPFBYPR= 0x5150,    /*!< Bypass HPF                                         */
    TFA9912_BF_DPSAL = 0x5160,    /*!< Enable DPSA left                                   */
    TFA9912_BF_DPSAR = 0x5170,    /*!< Enable DPSA                                        */
    ...
    TFA9912_BF_TALPFS= 0x5f40,    /*!< Tap decimator sampling Rate during Tap Mode        */
    TFA9912_BF_TDMDCG= 0x6123,    /*!< Total Gain attenuation setting for amplifier gain (tdm channel 1)  */
    TFA9912_BF_ANC1C = 0x68a0,    /*!< ANC one s complement                               */
    TFA9912_BF_DCMCC = 0x7033,    /*!< Max coil current (to be update)                    */
    ...
    TFA9912_BF_USERDEF= 0xf042,    /*!< Calibration delta current limit DCDC               */
...
#define TFA9912_NAMETABLE static tfaBfName_t Tfa9912DatasheetNames[]= {\
   ...
   { 0x600, "AUXSPKSEL"},    /* Main/Auxiliary input selectyed for TAP/SAM        , */\
   ...
   { 0x1300, "OCPOAPR"},    /* OCPOK pmos A                                      , */\
   { 0x1310, "OCPOANR"},    /* OCPOK nmos A                                      , */\
   { 0x1320, "OCPOBPR"},    /* OCPOK pmos B                                      , */\
   { 0x1330, "OCPOBNR"},    /* OCPOK nmos B                                      , */\
   { 0x1340, "CLIPAHR"},    /* Clipping A to Vddp                                , */\
   { 0x1350, "CLIPALR"},    /* Clipping A to gnd                                 , */\
   { 0x1360, "CLIPBHR"},    /* Clipping B to Vddp                                , */\
   { 0x1370, "CLIPBLR"},    /* Clipping B to gnd                                 , */\
   { 0x1380, "OCDSR"},    /* OCP  amplifier                                    , */\
   { 0x1390, "CLIPSR"},    /* Amplifier  clipping                               , */\
   ...
   { 0x1709, "VDDP"},    /* IC VDDP voltage ( 1023*VDDP/9.5 V)                , */\
   { 0x17a0, "DCILCF"},    /* DCDC current limiting                             , */\
   { 0x2000, "TDMUC"},    /* Usecase setting                                   , */\
   ...
   { 0x2330, "TDMGOE"},    /* Gain out control                                  , */\
   { 0x2340, "TDMVSE"},    /* Voltage sense                                     , */\
   { 0x2350, "TDMCSE"},    /* Current sense                                     , */\
   { 0x2360, "TDMCFE"},    /* DSP                                               , */\
   { 0x2370, "TDMCF2E"},    /* DSP 2                                             , */\
   { 0x2380, "TDMCF3E"},    /* DSP 3                                             , */\
   { 0x2390, "TDMES6"},    /* Cenable Data Strean for Source 6                  , */\
   { 0x23a0, "TDMES7"},    /* Cenable Data Strean for Source 7                  , */\
   ...
   { 0x24a1, "TDMCSIO"},    /* IO current sense                                  , */\
   { 0x24c1, "TDMCFIO"},    /* IO DSP                                            , */\
   { 0x24e1, "TDMCFIO2"},    /* IO DSP 2                                          , */\
   { 0x2643, "TDMLS"},    /* tdm slot for  channel in 1  (dcdc)                , */\
   { 0x2683, "TDMRS"},    /* Position audio right                              , */\
   { 0x26c3, "TDMGOS"},    /* Slot Position of Gain Out                         , */\
   { 0x2703, "TDMVSS"},    /* Slot Position of Voltage sense                    , */\
   { 0x2743, "TDMCSS"},    /* Position current sense                            , */\
   { 0x2783, "TDMCFS"},    /* Position DSP                                      , */\
   { 0x27c3, "TDMCF2S"},    /* Position DSP 2                                    , */\
   { 0x2803, "TDMCF3S"},    /* Slot Position of DSP 3                            , */\
   { 0x2843, "TDMEDAT6S"},    /* Slot Position of Extra Data                       , */\
   { 0x2883, "TDMEDAT7S"},    /* Slot Position of Extra Data                       , */\
   ...
   { 0x4260, "ISTLA"},    /* Status low amplidetude detection                  , */\
   ...
   { 0x42c0, "ISTTAPTRG"},    /* Status Tap comparator tiggered                    , */\
   ...
   { 0x5150, "HPFBYPR"},    /* Bypass HPF                                        , */\
   { 0x5160, "DPSAL"},    /* Enable DPSA left                                  , */\
   { 0x5170, "DPSAR"},    /* Enable DPSA                                       , */\
   ...
   { 0x5f40, "TALPFS"},    /* Tap decimator sampling Rate during Tap Mode       , */\
   { 0x6123, "TDMDCG"},    /* Total Gain attenuation setting for amplifier gain (tdm channel 1) , */\
   { 0x68a0, "ANC1C"},    /* ANC one s complement                              , */\
   { 0x7033, "DCMCC"},    /* Max coil current (to be update)                   , */\
...
#define TFA9912_BITNAMETABLE static tfaBfName_t Tfa9912BitNames[]= {\
   ...
   { 0x5d0, "enbl_cf_timer"},    /* CF Sub-system timer                               , */\
   { 0x5e0, "enbl_cf_wd"},    /* CF Sub-system WDT                                 , */\
   { 0x600, "aux_spkr_sel"},    /* Main/Auxiliary input selectyed for TAP/SAM        , */\
   { 0x610, "pdm2iis_en"},    /* PDM2IIS Brifge enable                             , */\
   ...
   { 0x2000, "tdm_usecase"},    /* Usecase setting                                   , */\
   ...
   { 0x2330, "tdm_source0_enable"},    /* Gain out control                                  , */\
   { 0x2340, "tdm_source1_enable"},    /* Voltage sense                                     , */\
   { 0x2350, "tdm_source2_enable"},    /* Current sense                                     , */\
   { 0x2360, "tdm_source3_enable"},    /* DSP                                               , */\
   { 0x2370, "tdm_source4_enable"},    /* DSP 2                                             , */\
   { 0x2380, "tdm_source5_enable"},    /* DSP 3                                             , */\
   { 0x2390, "tdm_source6_enable"},    /* Cenable Data Strean for Source 6                  , */\
   { 0x23a0, "tdm_source7_enable"},    /* Cenable Data Strean for Source 7                  , */\
   ...
   { 0x24a1, "tdm_source2_io"},    /* IO current sense                                  , */\
   ...
   { 0x2603, "tdm_sink0_slot"},    /* Control gainin (not used in DSP)                  , */\
   { 0x2643, "tdm_sink1_slot"},    /* tdm slot for  channel in 1  (dcdc)                , */\
   { 0x2683, "tdm_sink2_slot"},    /* Position audio right                              , */\
   { 0x26c3, "tdm_source0_slot"},    /* Slot Position of Gain Out                         , */\
   { 0x2703, "tdm_source1_slot"},    /* Slot Position of Voltage sense                    , */\
   { 0x2743, "tdm_source2_slot"},    /* Position current sense                            , */\
   { 0x2783, "tdm_source3_slot"},    /* Position DSP                                      , */\
   { 0x27c3, "tdm_source4_slot"},    /* Position DSP 2                                    , */\
   { 0x2803, "tdm_source5_slot"},    /* Slot Position of DSP 3                            , */\
   { 0x2843, "tdm_source6_slot"},    /* Slot Position of Extra Data                       , */\
   { 0x2883, "tdm_source7_slot"},    /* Slot Position of Extra Data                       , */\
   ...
   { 0x4260, "int_out_flag_low_amplitude"},    /* Status low amplidetude detection                  , */\
   ...
   { 0x42c0, "int_out_flag_tap_comp_trig"},    /* Status Tap comparator tiggered                    , */\
   ...
   { 0x5f40, "tap_fs_sel"},    /* Tap decimator sampling Rate during Tap Mode       , */\
   { 0x6081, "pga_gain_set"},    /* Amplifier gain selection                          , */\
   { 0x60b0, "pga_lowpass_enable"},    /* Lowpass enable                                    , */\
   { 0x60c0, "pga_pwr_enable"},    /* Power enable                                      , */\
   { 0x60d0, "pga_switch_enable"},    /* Switch enable                                     , */\
   { 0x60e0, "pga_switch_aux_enable"},    /* Switch enable aux                                 , */\
   { 0x6123, "ctrl_att"},    /* Total Gain attenuation setting for amplifier gain (tdm channel 1) , */\
   ...
   { 0x6761, "ctrl_rfb"},    /* Feedback resistor selection                       , */\
   ...
   { 0x6970, "cs_sam_set"},    /* Enable SAM input for current sense                , */\
   ...
   { 0x6b00, "disable_engage"},    /* Disable auto engange                              , */\
   ...
   { 0x6e40, "flag_cf_tapdetected"},    /* Status Tap  detected                              , */\
   { 0x6e50, "flag_tap_comp_trig"},    /* Status Tap comparator tiggered                    , */\
   { 0x7033, "boost_cur"},    /* Max coil current (to be update)                   , */\
   ...
   { 0xc707, "digimuxa_sel"},    /* DigimuxA input selection control routed to DIO1 (see Digimux list for details), */\
   { 0xc787, "digimuxb_sel"},    /* DigimuxB input selection control routed to DIO2 (see Digimux list for details), */\
   { 0xc807, "digimuxc_sel"},    /* DigimuxC input selection control routed to DIO3 (see Digimux list for details), */\
   ...
   { 0xcc05, "pll_seli_lbw"},    /* PLL SELI - Low B/W PLL control mode only          , */\
   { 0xcc64, "pll_selp_lbw"},    /* PLL SELP - Low B/W PLL control mode only          , */\
   { 0xccb3, "pll_selr_lbw"},    /* PLL SELR - Low B/W PLL control mode only          , */\
   ...
   { 0xd6e0, "enbl_wdt_clk"},    /* Enable WDT clock                                  , */\
   { 0xd6f0, "enbl_tim_clk"},    /* Enable Timer clock                                , */\
