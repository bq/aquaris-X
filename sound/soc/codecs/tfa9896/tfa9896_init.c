...
static enum Tfa98xx_Error tfa9896_specific(Tfa98xx_handle_t handle)
{
		...
		/*v12*/
        tfa98xx_write_register16(handle, 0x06, 0x000b); //POR=0x0001 //ATTEN=5 
        tfa98xx_write_register16(handle, 0x07, 0x3e7f); //POR=0x1e7f
        tfa98xx_write_register16(handle, 0x0a, 0x0d8a); //POR=0x0592
        tfa98xx_write_register16(handle, 0x48, 0x0300); //POR=0x0308
        tfa98xx_write_register16(handle, 0x88, 0x0100); //POR=0x0000
